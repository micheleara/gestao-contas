...
import br.com.banco.gestao_contas.adapters.out.persistence.mapper.ContaMapper;
import br.com.banco.gestao_contas.adapters.out.persistence.repository.SpringDataContaRepository;
...
public class ContaPersistenceAdapter implements ContaRepositoryPort {
    ...
    public ContaPersistenceAdapter(SpringDataContaRepository repository, ContaMapper mapper) {
